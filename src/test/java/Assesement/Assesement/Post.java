...
public class Post {
	...
	File jsonData=new File("C:/Users/7000032450/eclipse-workspace/Assesement/json/json1/data1.json");
	 RestAssured.given().header("Authorization","Bearer 24f4362e9a1a17afa8ad5da989bae75c6fe09f271913f5a71c27b88726157fed").
	baseUri("https://gorest.co.in/public/v1/users").
	contentType(ContentType.JSON).body(jsonData).when().post().then().
	log().all();
...
header("Authorization","Bearer 24f4362e9a1a17afa8ad5da989bae75c6fe09f271913f5a71c27b88726157fed").
baseUri("https://gorest.co.in/public/v1/users").
queryParam("email","siddharth14@matrix.com").when().get();
